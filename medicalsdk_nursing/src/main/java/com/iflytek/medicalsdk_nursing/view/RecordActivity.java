...
public class RecordActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        speechHelper = new SpeechHelper(RecordActivity.this);
        mSpeechUnderstander = speechHelper.getmSpeechUnderstander();
        voicePathList = new ArrayList<>();
        initData();
        initVolley();
...
//        String serverUrl = "http://192.168.1.100:8732/ws/NRService";
...
//        Log.d("SCREAN_X_Y",width+"------"+height);
     ...
     * 保存护理记录数据
     */
    public void saveRecordInfo(List<FormCheck> formCheckList) {
...
//             以下代码用于获取与云端的会话id，当业务出错时将会话id提供给技术支持人员，可用于查询会话日志，定位出错原因
    ...
    public void playVoice(int count) {
        ...
        mediaplayerUtil.playSoundList(Arrays.asList(voicePathList.get(count).split(",")), new MediaplayerUtil.MediaplayerPlayStateListener() {
            @Override
